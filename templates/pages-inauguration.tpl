...
<div class="slider-wrapper theme-default" style="margin:auto; width:80%;">
    <div id="slider">
        <img src="images/inauguration1.jpeg" alt="" title="Éric Sannier, fondateur du projet<br />Paul, Élise Mc Crate et son mari, les principaux donateurs." />
        <img src="images/inauguration2.jpeg" alt="" title="Éric Sannier, fondateur du projet ; Brigitte Kervalla (professeur à l'IUT d'Amiens)<br />Jean Traullé, Adeline Blin et Dorine Talfer (étudiants à l'IUT et développeurs du site Internet)." />
        <img src="images/inauguration3.jpeg" alt="" />
    </div>
</div>