<html>
    ...
    <body>
        <div class='container'>
            <div class="content">
                ...
                <footer>
                    ...
                    {else}
                    <p><a href="https://github.com/jtraulle/Jim-s--book-corner/">JBCL ILS</a>, <a href="https://github.com/jtraulle/Jim-s--book-corner/commit/{include file="lastrevid.tpl"}">rev. {include file="lastrevid.tpl"}</a> &nbsp;{if $statut == 'gestionnaire'}<a href="?module=index&action=recalculsha"><img style="vertical-align:top;" src="images/refresh.png" class="infobulle" data-placement="above" rel="twipsy" data-original-title="Mettre à jour le hash vers le dernier commit du dépôt public Github." /></a>{/if}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<em>Réalisation département informatique de l'<acronym title="Institut Universitaire de Technologie">IUT</acronym> d'Amiens</em> - <a href="?module=pages&action=credits">Crédits</a> <span style="float:right;"><img style="vertical-align:top;" src="images/bug.png" /> <a href="http://projets.opencomp.fr/thebuggenie/jim-s--book-corner/issues/new">Signaler une anomalie</a></span></p>
                    {/if}
                </footer>
            </div>
        </div>
        ...
        <script type="text/javascript">
		  var _gaq = _gaq || [];
		  _gaq.push(['_setAccount', 'UA-36944674-1']);
