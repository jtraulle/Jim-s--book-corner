<ul class="tabs">
                            ...
                            {if $statut == 'gestionnaire'}<li {if $module == 'gestemprunteur'}class="active"{/if}><a href="?module=gestemprunteur">Emprunteurs</a></li>
                            <li {if $module == 'gestemprunt' OR $module == 'gestreservation'}class="active"{/if}><a href="?module=gestemprunt">Circulation</a></li>{/if}
