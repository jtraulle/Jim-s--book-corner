...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'numRueEmprunteur' => ['type' => 'integer', 'length' => 4, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'nomRueEmprunteur' => ['type' => 'string', 'length' => 150, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'villeEmprunteur' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'CodePostalEmprunteur' => ['type' => 'string', 'length' => 5, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'telFixeEmprunteur' => ['type' => 'string', 'length' => 10, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'telPortableEmprunteur' => ['type' => 'string', 'length' => 10, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'email' => ['type' => 'string', 'length' => 150, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'nbLivresDonnes' => ['type' => 'integer', 'length' => 10, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'numRueEmprunteur' => 1,
                'nomRueEmprunteur' => 'Lorem ipsum dolor sit amet',
                'villeEmprunteur' => 'Lorem ipsum dolor sit amet',
                'CodePostalEmprunteur' => 'Lor',
                'username' => 'Lorem ipsum dolor sit amet',
                'password' => 'Lorem ipsum dolor sit amet',
                'telFixeEmprunteur' => 'Lorem ip',
                'telPortableEmprunteur' => 'Lorem ip',
                'email' => 'Lorem ipsum dolor sit amet',
                'nbLivresDonnes' => 1,
                'token' => 'Lorem ipsum dolor sit amet',
                'token_expires' => '2019-03-14 21:29:41',
                'api_token' => 'Lorem ipsum dolor sit amet',
                'activation_date' => '2019-03-14 21:29:41',
                'tos_date' => '2019-03-14 21:29:41',
                'active' => 1,
                'is_superuser' => 1,
                'role' => 'Lorem ipsum dolor sit amet',
                'created' => '2019-03-14 21:29:41',
                'modified' => '2019-03-14 21:29:41'
            ],
        ];
        parent::init();
    }
