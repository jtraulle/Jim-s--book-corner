...
function enregistrer(){
	...
	function modifier(){
		$sql="UPDATE gestionnaire SET nomGestionnaire=?,prenomGestionnaire=?,pseudoGestionnaire=?,mdpGestionnaire=?,telGestionnaire=?,emailestionnaire=?";
		$res=$this->db->prepare($sql);
		$res->execute(array(
			$this->nomGestionnaire,
			$this->prenomGestionnaire,
